## Set up k6 operator.
#
#resource "null_resource" "build_k6_operator" {
...
#  depends_on = [kubernetes_secret.k6_influxdb_info]
...
#  name = "K6InfluxDBCredentials"
#}
#
#data "aws_secretsmanager_secret_version" "k6_influxdb_secret" {
...
#  }
#  data = {
#    "INFLUXDB_WRITE_USER_PASSWORD" = jsondecode(data.aws_secretsmanager_secret_version.k6_influxdb_secret.secret_string)["k6_write_user_password"]
#    "INFLUXDB_READ_USER_PASSWORD" = jsondecode(data.aws_secretsmanager_secret_version.k6_influxdb_secret.secret_string)["k6_read_user_password"]
#    "INFLUXDB_USER_PASSWORD" = jsondecode(data.aws_secretsmanager_secret_version.k6_influxdb_secret.secret_string)["k6_user_password"]
#    "INFLUXDB_ADMIN_PASSWORD" = jsondecode(data.aws_secretsmanager_secret_version.k6_influxdb_secret.secret_string)["k6_admin_password"]
#  }
#  depends_on = [data.aws_secretsmanager_secret_version.k6_influxdb_secret]
#}
#
## EFS Persistances
#
...
#  name = "K6GrafanaCredentials"
#}
#
#data "aws_secretsmanager_secret_version" "k6_grafana_secret" {
...
#    "admin-password" = jsondecode(data.aws_secretsmanager_secret_version.k6_grafana_secret.secret_string)["k6_admin_password"]
#  }
#  depends_on = [data.aws_secretsmanager_secret_version.k6_grafana_secret]
#}